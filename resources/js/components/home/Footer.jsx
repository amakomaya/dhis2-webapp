                        ...
                        <section className="">
                            <div className="row">
                                ...
                                <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                                    ...
                                    <p><i className="fas fa-envelope mr-3"></i> dhis2@amakomaya.com</p>
                                    <p><i className="fas fa-envelope mr-3"></i> dhis2.amakomaya@gmail.com</p>

                                    <p><i className="fas fa-phone mr-3"></i> 01-4528090</p>
                                    <p><i className="fas fa-phone mr-3"></i> <a href="tel:+977 9851341921" style={{textDecoration:'none', color:'white'}}>  9851341921</a></p>
